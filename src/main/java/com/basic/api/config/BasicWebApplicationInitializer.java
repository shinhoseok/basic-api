...
public class BasicWebApplicationInitializer implements WebApplicationInitializer {
    private static final Logger LOGGER = LoggerFactory.getLogger(BasicWebApplicationInitializer.class);
    @Override
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        // -------------------------------------------------------------
        servletContext.addListener(new BasicWebServletContextListener());
        // -------------------------------------------------------------
        // 필터설정
        // -------------------------------------------------------------
    ...
    private void addRootContext(ServletContext servletContext) {
        ...
        rootContext.register(BasicConfig.class);
    ...
    private void addWebServletContext(ServletContext servletContext) {
        ...
        webApplicationContext.register(BasicConfigWebDispatcherServlet.class);
